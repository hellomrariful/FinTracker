...
const envSchema = z.object({
  ...
  NODE_ENV: z
    ...
    .default("development"),
  NEXT_PUBLIC_APP_URL: z.string().url().default("https://fintracker.io"),
  ...
  // Email Configuration
  EMAIL_FROM: z.string().email().default("info.fintracker@gmail.com"),
  ...
  ENABLE_NOTIFICATIONS: z
    ...
    .transform((val) => val === "true")
    .default("true"),
  ENABLE_RECURRING_TRANSACTIONS: z
    .string()
    .transform((val) => val === "true")
    .default("true"),
